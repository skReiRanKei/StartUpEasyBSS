...
7)　掲示板編集　：掲示板の内容を編集　（権限がある場合のみ可能）

8） 掲示板削除　：掲示板削除（権限がある場合のみ可能）
...
例外処理を意識した造りにした。
目的は勉強のため、アカウント登録、ログイン、権限付与、権限による制限機能を追加した。
...
#### 掲示板参照（権限なし）
![掲示板参照権限なし](images/NoAuthority.png "権限がない場合は返信と参照のみ可能です。")

#### 掲示板参照
![掲示板参照](images/AfterSelecting.png "参照、返信、そして掲示板の編集や削除用の画面へ遷移可能です。")
